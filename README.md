...
2. 2.Exécutez votre premier conteneur avec l’image hello-world.
...
1. Créez un dossier fullstack-app pour votre projet.
...
7. Lancez la stack complète avec Docker Compose.
8. Testez la connectivité entre tous les services.
9. Ajoutez un service adminer pour administrer la base.
10. Implémentez des health checks pour tous les services.
